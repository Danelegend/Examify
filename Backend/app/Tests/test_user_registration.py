...
from app.functionality.authentication.authentication import RegisterUser
from app.functionality.token import access_token_valid, get_user_id, refresh_token_valid
...
def check_all_user_profile_attributes_filled(obj: UserForm) -> bool:
    from app.functionality.authentication.user_form import USER_PROFILE_DEFAULT_VAL
